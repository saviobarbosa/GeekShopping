...
{
    public class RabbitMQChechoutConsumer : BackgroundService
    {
        ...
        public RabbitMQChechoutConsumer(OrderRepository repository, IRabbitMQMessageSender rabbitMQMessageSender)
        {
